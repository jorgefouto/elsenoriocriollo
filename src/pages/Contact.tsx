            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-restaurant-muted p-8 rounded-lg border border-restaurant-gold/20 text-center">
                ...
                <p className="text-gray-300 mb-2">
                  <a href="tel:4045551234" className="hover:text-restaurant-gold transition-colors">
                    (404) 555-1234
                  </a>
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="bg-restaurant-dark border-restaurant-gold/20 focus:border-restaurant-gold"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className="w-full h-32 px-3 py-2 text-restaurant-light bg-restaurant-dark border border-restaurant-gold/20 rounded-md focus:outline-none focus:border-restaurant-gold"
