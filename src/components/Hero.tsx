...
const Hero = () => {
  return <section className="relative hero-height w-full bg-image overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1544148103-0773bf10d330?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Restaurant ambiance" className="w-full h-full object-cover" />
      ...
      <div className="container mx-auto px-4 relative h-full z-10 flex flex-col justify-center">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold mb-6 animate-fade-up">
            <span className="text-restaurant-gold">Peruvian Cuisine</span> with a Classic Touch
          </h1>
